  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="300" height="300">
      ...
      <circle
        ...
        stroke-width="20"
        fill="none"
        stroke-dashoffset={[offset + labelSegment * pathLength]}
        stroke-dasharray={[warmup, sprint, rest, sprint, rest, sprint, rest, sprint, rest, sprint, warmup].map(
          (x, index) => (index === 0 ? x : x * squeezeDown),
        )}
      />
